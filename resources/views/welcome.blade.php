            ...
            <div class="row align-items-center">
                <div class="col-12 col-lg-6 hero-text text-center text-lg-start">
                    ...
                    <p class="lead text-muted mb-5">
                        {{ setting('web_hero_subtitle', 'Discover the authentic taste of locally sourced, premium coffee beans. Roasted to perfection for those who appreciate the finer details.') }}
                    </p>
                ...
                <div class="col-lg-6 mt-5 mt-lg-0 text-center">
                    <div class="position-relative">
                        @if($heroSliders->count() > 0)
                            <div id="heroCarousel" class="carousel slide hero-img shadow-lg" data-bs-ride="carousel"
                                data-bs-interval="3000">
                                <div class="carousel-inner h-100 rounded-3 overflow-hidden">
                                    @foreach($heroSliders as $key => $slider)
                                        <div class="carousel-item h-100 {{ $key == 0 ? 'active' : '' }}">
                                            <img src="{{ asset($slider->image_path) }}" class="d-block w-100 h-100 object-fit-cover"
                                                alt="{{ $slider->title }}">
                                        </div>
                                    @endforeach
                                </div>
                        ...
                        @else
                            ...
                            <img src="{{ asset('images/coffee-hero.jpg') }}"
                                onerror="this.src='https://placehold.co/600x600/5f674d/FFF?text=Watu+Coffee'"
                                alt="Watu Coffee Hero" class="img-fluid hero-img">
                        @endif
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-5 mb-5 mb-lg-0">
                    ...
                    @if($aboutSliders->count() > 0)
                        <div id="aboutCarousel" class="carousel slide arca-illustration shadow-lg rounded-lg overflow-hidden"
                    ...
                    @else
                        <!-- Fallback Static -->
                        <img src="{{ asset('images/roastery.jpg') }}"
                            onerror="this.src='https://placehold.co/500x700/eaddcf/5f674d?text=Roastery'" alt="Our Roastery"
                            class="img-fluid rounded-lg shadow-lg arca-illustration">
                    @endif
                </div>
                <div class="col-lg-6 offset-lg-1">
                    <div class="form-card border-0 bg-transparent shadow-none">
                        ...
                        <h2 class="font-serif font-weight-bold mb-4">{{ setting('web_about_title', 'More Than Just Coffee') }}</h2>
                        <p class="text-muted mb-4" style="line-height: 1.8;">
                            {{ setting('web_about_desc_1', 'At Watu Coffee, we believe that every cup tells a story. From the farmers who cultivate the beans to our master roasters who bring out their unique flavors, we are dedicated to excellence at every step.') }}
                        </p>
                        <p class="text-muted mb-4" style="line-height: 1.8;">
                            {{ setting('web_about_desc_2', 'Our journey began with a simple passion: to find the perfect bean. Today, we share that passion with you through our carefully curated selection of single-origin blends and signature roasts.') }}
                        </p>
                        <div class="row mt-5">
                            ...
                            <div class="col-4 text-center">
                                ...
                                <small class="text-uppercase text-muted letter-spacing-1 font-weight-bold">Fresh
                                    Roast</small>
                            </div>
                            <div class="col-4 text-center">
    ...
    <section class="section-padding" style="background-color: var(--color-cream);">
        <div class="container">
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-end mb-5 px-2">
                ...
                <a href="{{ route('order') }}"
                    class="btn btn-watu-outline rounded-pill d-none d-md-inline-block hover-lift">View Full Menu</a>
            </div>
                ...
                <div class="row flex-nowrap m-0 p-0" id="featuredSlider">
                    ...
                    @forelse($topProducts as $product)
                        ...
                        <div class="col-10 col-md-4 mb-4 px-2 scroll-item">
                            <div
                                class="form-card h-100 text-center p-4 d-flex flex-column align-items-center transition-hover shadow-sm border-0">
                                ...
                                <p class="text-muted mb-3 small">
                                    {{ Str::limit($product->description ?? 'Delicious authentic flavor.', 60) }}</p>

                                @if($product->category_id == 2) <!-- Roastery -->
                                    <a href="{{ route('order') }}#pills-beans"
                                        class="btn btn-sm btn-watu-primary w-100 rounded-pill mt-auto">Buy</a>
                                @else
                                    <a href="{{ route('order') }}"
                                        class="btn btn-sm btn-watu-outline w-100 rounded-pill mt-auto">Order Now</a>
                                @endif
                            </div>
                        </div>
                    @empty
