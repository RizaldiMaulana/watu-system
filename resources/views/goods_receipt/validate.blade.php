                    ...
                    <div class="flex items-center gap-4">
                        <form action="{{ route('goods-receipt.verify', $purchase->id) }}" method="POST" class="flex items-center gap-4">
                            ...
                            @else
                                ...
                                <button type="submit" onclick="return confirm('Apakah Anda yakin data sudah benar?')" class="px-6 py-3 bg-[#5f674d] hover:bg-[#4b523d] text-white font-bold rounded-xl shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all flex items-center gap-2">
