        ...
        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 max-w-lg">
            <form action="{{ route('promotions.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="name" required class="w-full rounded-lg border-gray-300 focus:ring-[#5f674d] focus:border-[#5f674d]" placeholder="Contoh: Diskon Karyawan">
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="value" required min="0" step="0.01" class="w-full rounded-lg border-gray-300 focus:ring-[#5f674d] focus:border-[#5f674d]" placeholder="Contoh: 10 atau 5000">
                </div>

                <div class="mb-6">
                    <label class="flex items-center">
                        <input type="checkbox" name="is_active" value="1" checked class="rounded border-gray-300 text-[#5f674d] shadow-sm focus:border-[#5f674d] focus:ring-[#5f674d]">
