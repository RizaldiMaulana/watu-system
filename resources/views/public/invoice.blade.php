        ...
        <div class="container">
            ...
            <div class="invoice-card">
                ...
                <div class="invoice-header">
                    <img src="{{ asset(setting('logo_invoice', 'images/LOGO Produk.png')) }}" alt="Logo"
                        style="width: 80px;">
                ...
                <div class="d-flex justify-content-between mb-4 small text-muted">
                    <div>
                        ...
                        <strong>Method:</strong> <span
                            class="text-uppercase text-olive fw-bold">{{ $transaction->payment_method }}</span>
                    </div>
                    <div class="text-end">
                                    ...
                                    @if(!empty($item->options) && is_array($item->options))
                                        <div class="text-muted small" style="font-size: 11px; margin-top: 2px;">
                                            @foreach($item->options as $key => $value)
                                                <div><span class="text-uppercase" style="font-weight: 600;">{{ $key }}:</span>
                                                    {{ $value }}</div>
                                            @endforeach
                                        </div>
                                    @endif
