        ...
        <div class="bg-white shadow-sm sm:rounded-lg p-4 mb-6 flex justify-between items-center">
            ...
            <form method="GET" class="flex flex-wrap gap-2 items-center">
                ...
                <div class="ml-4 flex gap-2 border-l pl-4 border-gray-300">
                    <a href="{{ route('reports.print', ['type' => 'balance-sheet', 'date' => $endDate]) }}" target="_blank" class="bg-blue-600 text-white px-3 py-2 rounded-lg text-sm font-bold hover:bg-blue-700 flex items-center gap-1" title="Print PDF">
                    ...
                    <a href="{{ route('reports.print', ['type' => 'balance-sheet', 'date' => $endDate, 'export' => 'excel']) }}" target="_blank" class="bg-green-600 text-white px-3 py-2 rounded-lg text-sm font-bold hover:bg-green-700 flex items-center gap-1" title="Export Excel">
