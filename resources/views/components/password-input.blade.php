...
<div x-data="{ show: false }" class="relative">
    <input 
        ...
        @disabled($disabled) 
        {{ $attributes->merge(['class' => 'border-gray-300 focus:border-[#5f674d] focus:ring-[#5f674d] rounded-lg shadow-sm w-full pr-10']) }}
    >
    <button type="button" @click="show = !show" class="absolute inset-y-0 right-0 px-3 flex items-center text-gray-500 hover:text-gray-700 focus:outline-none">
        <!-- Eye Icon (Show) -->
